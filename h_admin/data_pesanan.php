...
//   $path           = "../upload/";
$queryy = "INSERT INTO transaksi_penjualan VALUES ('', '$id_cust', '$id_barang', '$keterangan', '$tgl_jual', '$total_harga', '$modal')";
...
if(isset($_POST['ganti'])){
		...
		$query3 = "UPDATE transaksi_penjualan set id_cust='$id_cust', id_barang='$id_barang', keterangan='$keterangan', tgl_jual='$tgl_jual', total_harga='$total_harga', modal='$modal' WHERE id_penjualan='$id_penjualan'"; 
										...
										<form name="form1" class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
											<div class="form-group">
												...
												<div class="col-xs-4 col-sm-5">
													<select name="nama" class="chosen-select col-xs-12 col-sm-12 form-control">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> Modal </label>
												<div class="col-sm-5">
													<textarea class="form-control" id="form-field-8" name="modal" placeholder="Modal"></textarea>
												</div>
												<label class="col-sm-1 control-label no-padding-right" for="form-field-1-1"> </label>
												<div class="col-sm-4">
												</div>
										...
										<div style="overflow: auto;">
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php
													...
													$query = "SELECT c.nama, c.alamat, c.telepon, p.keterangan, p.tgl_jual, p.total_harga, p.id_penjualan, r.nama_barang FROM transaksi_penjualan as p, tb_customer as c, produk as r
