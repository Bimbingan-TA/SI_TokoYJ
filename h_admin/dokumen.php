...
include "../k.php";
	...
	if(isset($_POST['on'])){
		...
		$query3 = "UPDATE laporan_penjualan set modal=1 WHERE id_laporan='$id_laporan'"; 
	...
	if(isset($_POST['off'])){
		$id_laporan=$_POST['id_laporan'];
		$query3 = "UPDATE laporan_penjualan set modal=0 WHERE id_laporan='$id_laporan'"; 
									...
									<div class="col-xs-12">
										...
										<div style="overflow: auto;">
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
													$querym = "SELECT * FROM laporan_penjualan";
													$sqlm = mysqli_query($connect, $querym);
													$no = 1;
													while ($datam = mysqli_fetch_array($sqlm)) { ?>
														<tr>
															
															<td><?php echo $datam['id_laporan']; ?></td>
															<td><?php echo $datam['id_penjualan']; ?></td>
															<td><?php echo $datam['modal']; ?></td>
															...
															<form class="form-horizontal" role="form" form action="" method="post" enctype="multipart/form-data">
																<input type="hidden" name="id_laporan" value="<?php echo $datam['id_laporan']; ?>" />
																<button name="on" type="submit" class="label label-lg label-success" ><i class="ace-icon fa fa-eye"></i></button>
																<button name="off" type="submit" class="label label-lg label-danger" ><i class="ace-icon fa fa-eye-slash"></i></button>									
															</form>
															</td>
														</tr>
													<?php $no++; }
