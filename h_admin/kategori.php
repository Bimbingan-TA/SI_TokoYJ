...
$queryy = "INSERT INTO kategori_produk VALUES ('', '$nama_kategori', '$keterangan')";
...
if(isset($_POST['ganti'])){
	...
	if(isset($_POST['on'])){
		...
		$query3 = "UPDATE kategori_produk WHERE id_kategori='$id_kategori'"; 
								...
								<div class="col-sm-10 alert alert-info" style="padding-bottom:0px;">
										...
										<form name="form1" class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" name="nama_kategori" id="form-field-1-1" placeholder="Nama Kategori"  />
												</div>	
												<div class="col-sm-4">
												</div>
											</div>
