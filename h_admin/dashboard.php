      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="i_box bg-gr">
            <span class="i_box-icon"><i class="fa fa-file"></i></span>
            <?php
            $queryu = "SELECT COUNT(id_laporan) as jml FROM laporan_penjualan";
            $sqlu = mysqli_query($connect, $queryu);
            $c_user = mysqli_fetch_assoc($sqlu);
            ?>
            <div class="i_box-content">
              <span class="i_box-text">Laporan</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="i_box bg-ye">
            ...
            ?>
            <div class="i_box-content">
              <span class="i_box-text">Katalog</span>
              <span class="i_box-number"><?php echo $c_user['jml']; ?></span>
              <span class="progress-description">
                Katalog Produk
              </span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="i_box bg-re">
            ...
            <?php
            $queryu = "SELECT COUNT(id_admin) as jml FROM tb_admin";
            $sqlu = mysqli_query($connect, $queryu);
            $c_user = mysqli_fetch_assoc($sqlu);
            ?>
            <div class="i_box-content">
              <span class="i_box-text">Admin</span>
              <span class="i_box-number"><?php echo $c_user['jml']; ?></span>
              <span class="progress-description">
                Admin YJ Mebel
              </span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="i_box bg-ye">
            ...
            ?>
            <div class="i_box-content">
              <span class="i_box-text">Kategori</span>
              <span class="i_box-number"><?php echo $c_user['jml']; ?></span>
              <span class="progress-description">
                Kategori Produk YJ Mebel
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="i_box bg-re">
            ...
            ?>
            <div class="i_box-content">
              <span class="i_box-text">Anggota</span>
              <span class="i_box-number"><?php echo $c_user['jml']; ?></span>
              <span class="progress-description">
                Anggota Member
              </span>
