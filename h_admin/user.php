...
if(isset($_POST['ganti'])){
		$id_cust=$_POST['id_cust'];
		$nama=$_POST['nama'];
		$username = $_POST['username_cust'];
		$alamat=$_POST['alamat'];
		$telepon=$_POST['telepon'];

		$query3 = "UPDATE tb_customer set nama='$nama', username='$username_cust', alamat='$alamat', telepon='$telepon' WHERE id_cust='$id_cust'"; 
														...
														<div class="modal-content">
															<div class="modal-header no-padding">
																<div class="table-header">
																	...
																	Form Edit Master Proyek " <?php echo $datam['nama'] . " - " . $datam['username_cust']; ?> "
																</div>
															</div>
															<form class="form-horizontal" role="form" form action="" method="post" enctype="multipart/form-data">
															<div class="modal-body">
